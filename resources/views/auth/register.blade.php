    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4 text-end position-relative">
            ...
            <input type="password" id="password_confirmation" name="password_confirmation"
                class="form-control ps-5 @error('password_confirmation') is-invalid @enderror" required>
        ...
        <button type="submit" class="btn btn-custom w-100 py-2">تسجيل</button>
    </form>

    <div class="login-footer mt-3">
        <a href="{{ route('user.login') }}" class="text-decoration-none text-info">لديك حساب؟ تسجيل الدخول</a>
    </div>
